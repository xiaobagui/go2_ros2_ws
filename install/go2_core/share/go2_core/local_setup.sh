...
: ${AMENT_CURRENT_PREFIX:="/home/unitree/go2_ros2_ws/install/go2_core"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_core/environment/pythonpath.sh"
