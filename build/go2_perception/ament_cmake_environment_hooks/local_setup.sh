...
: ${AMENT_CURRENT_PREFIX:="/home/unitree/go2_ros2_ws/install/go2_perception"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_perception/environment/pythonpath.sh"
